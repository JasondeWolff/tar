...
use crate::wgpu_util::context_wrapper::ContextWrapper;
...
impl SurfaceWrapper {
    ...
    pub fn resume(&mut self, context: &ContextWrapper, window: Arc<Window>, srgb: bool) {
    ...
    pub fn resize(&mut self, context: &ContextWrapper, size: PhysicalSize<u32>) {
    ...
    pub fn acquire(&mut self, context: &ContextWrapper) -> Option<wgpu::SurfaceTexture> {
